...
import { logPerformance, logAPIError } from './logger'
  ...
  async initialize(): Promise<void> {
    ...
    try {
      ...
      this.pool.on('connect', (client) => {
        ...
        console.log(`Database client connected. Total connections: ${this.connectionCount}`)
      })
      ...
      this.pool.on('remove', (client) => {
        this.connectionCount--
        console.log(`Database client removed. Total connections: ${this.connectionCount}`)
      })
